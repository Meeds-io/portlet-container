...
@TestCase(value = Assertion.JSR168_38, enabled = false)
public class NotInvokeModeDeclaredForNotSupportedMarkup
{
   public NotInvokeModeDeclaredForNotSupportedMarkup(PortletTestCase seq)
   {
